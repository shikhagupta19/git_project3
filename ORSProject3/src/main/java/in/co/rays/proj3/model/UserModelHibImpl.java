...
public class UserModelHibImpl implements UserModelInt {
	...
	public long add(UserDTO dto) throws ApplicationException, DuplicateRecordException {
		...
		// Check if updated LoginId already exist
		  ...
		  System.out.println("chack" +existLoginDto); if (existLoginDto != null) {
	...
	public List search(UserDTO dto, int pageNo, int pageSize) throws ApplicationException {
		...
		System.out.println("inside search of umodelhib=======");
		Session session = null;
		List list = null;
		...
		try {
			...
			System.out.println("exception in umodelhib impl========");
			log.error("Database Exception..", e);
